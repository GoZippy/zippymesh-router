...
// Check if settings has ZippyMesh customModels
const hasZippyMeshConfig = (settings) => {
  if (!settings || !settings.customModels) return false;
  return settings.customModels.some(m => m.id === "custom:ZippyMesh-0");
};
...
// POST - Update ZippyMesh customModels (merge with existing settings)
...
// DELETE - Remove ZippyMesh customModels only (keep other settings)
