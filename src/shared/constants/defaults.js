...
export const SMART_PLAYBOOK_TEMPLATES = [
    ...
    // === Task-Specific Intent Playbooks ===
    {
        id: "tpl-refactor",
        name: "zippymesh/refactor",
        description: "Code refactoring and cleanup. Claude (precise rewrites), DeepSeek, GPT-4o.",
        trigger: { type: "intent", value: "refactor" },
        rules: [
            { type: "boost", target: "claude-sonnet", value: 82000 },
            { type: "boost", target: "claude-opus", value: 78000 },
            { type: "boost", target: "deepseek-v3", value: 72000 },
            { type: "boost", target: "gpt-4o", value: 68000 },
            { type: "boost", target: "qwen-2.5-coder", value: 60000 },
            { type: "stack", target: "anthropic,deepinfra,openai,groq,ollama", value: "failover" }
        ]
    },
    {
        id: "tpl-plan",
        name: "zippymesh/plan",
        description: "Project planning, task breakdown, roadmaps. Strong reasoning models.",
        trigger: { type: "intent", value: "plan" },
        rules: [
            { type: "boost", target: "claude-opus", value: 88000 },
            { type: "boost", target: "claude-sonnet", value: 80000 },
            { type: "boost", target: "gpt-4o", value: 75000 },
            { type: "boost", target: "gemini-2.5-pro", value: 72000 },
            { type: "boost", target: "deepseek-r1", value: 65000 },
            { type: "stack", target: "anthropic,openai,gemini,deepinfra,openrouter", value: "failover" }
        ]
    },
    {
        id: "tpl-creative",
        name: "zippymesh/creative",
        description: "Creative writing, fiction, storytelling, poetry, brainstorming.",
        trigger: { type: "intent", value: "creative" },
        rules: [
            { type: "boost", target: "claude-opus", value: 85000 },
            { type: "boost", target: "claude-sonnet", value: 78000 },
            { type: "boost", target: "gpt-4o", value: 72000 },
            { type: "boost", target: "gemini-2.5-pro", value: 65000 },
            { type: "boost", target: "llama-3.3-70b", value: 55000 },
            { type: "stack", target: "anthropic,openai,gemini,groq,ollama,lmstudio", value: "failover" }
        ]
    },
    {
        id: "tpl-legal",
        name: "zippymesh/legal",
        description: "Legal research, contract analysis, regulatory review. Precise, citation-aware models.",
        trigger: { type: "intent", value: "legal" },
        rules: [
            { type: "boost", target: "claude-opus", value: 92000 },
            { type: "boost", target: "claude-sonnet", value: 85000 },
            { type: "boost", target: "gpt-4o", value: 80000 },
            { type: "boost", target: "gpt-4-turbo", value: 75000 },
            { type: "boost", target: "gemini-2.5-pro", value: 70000 },
            { type: "stack", target: "anthropic,openai,gemini,openrouter", value: "failover" }
        ]
    },
    {
        id: "tpl-summarize",
        name: "zippymesh/summarize",
        description: "Summarization, TL;DR, key-point extraction. Fast and efficient.",
        trigger: { type: "intent", value: "summarize" },
        rules: [
            { type: "sort-by-cheapest", target: "*" },
            { type: "boost", target: "gemini-2.5-flash", value: 75000 },
            { type: "boost", target: "claude-sonnet", value: 70000 },
            { type: "boost", target: "gpt-4o-mini", value: 65000 },
            { type: "boost", target: "llama-3.3-70b", value: 58000 },
            { type: "boost", target: "groq", value: 55000 },
            { type: "stack", target: "gemini,anthropic,openai,groq,cerebras,ollama,lmstudio", value: "failover" }
        ]
    },
    {
        id: "tpl-translate",
        name: "zippymesh/translate",
        description: "Language translation, multilingual content. Gemini and GPT-4o excel here.",
        trigger: { type: "intent", value: "translate" },
        rules: [
            { type: "boost", target: "gemini-2.5-pro", value: 82000 },
            { type: "boost", target: "gpt-4o", value: 78000 },
            { type: "boost", target: "claude-sonnet", value: 72000 },
            { type: "boost", target: "deepseek-v3", value: 62000 },
            { type: "boost", target: "llama-3.3-70b", value: 55000 },
            { type: "stack", target: "gemini,openai,anthropic,deepinfra,groq,ollama", value: "failover" }
        ]
    },
    {
        id: "tpl-data-analysis",
        name: "zippymesh/data-analysis",
        description: "Data analysis, interpretation, statistics, structured reasoning. Strong reasoning models.",
        trigger: { type: "intent", value: "analysis" },
        rules: [
            { type: "boost", target: "claude-opus", value: 88000 },
            { type: "boost", target: "gemini-2.5-pro", value: 82000 },
            { type: "boost", target: "gpt-4o", value: 78000 },
            { type: "boost", target: "deepseek-r1", value: 70000 },
            { type: "boost", target: "claude-sonnet", value: 68000 },
            { type: "stack", target: "anthropic,gemini,openai,deepinfra,openrouter", value: "failover" }
        ]
    },
    {
        id: "tpl-ocr-technical",
        name: "zippymesh/ocr-technical",
        description: "OCR for technical content: schematics, code screenshots, diagrams, data tables, specs. Vision models with high accuracy.",
        trigger: { type: "intent", value: "ocr_technical" },
        rules: [
            { type: "require-capability", target: "vision", value: true },
            { type: "boost", target: "claude-sonnet", value: 88000 },
            { type: "boost", target: "claude-opus", value: 85000 },
            { type: "boost", target: "gpt-4o", value: 80000 },
            { type: "boost", target: "gemini-2.5-pro", value: 75000 },
            { type: "stack", target: "anthropic,openai,gemini,openrouter", value: "failover" }
    ...
    {
        id: "tpl-ocr-image",
        name: "zippymesh/ocr-image",
        description: "OCR for general images: photos, scanned documents, handwriting, signs. Multimodal vision models.",
        trigger: { type: "intent", value: "ocr_image" },
        rules: [
            { type: "require-capability", target: "vision", value: true },
            { type: "boost", target: "gemini-2.5-pro", value: 88000 },
            { type: "boost", target: "gpt-4o", value: 85000 },
            { type: "boost", target: "claude-sonnet", value: 80000 },
            { type: "boost", target: "claude-opus", value: 75000 },
            { type: "stack", target: "gemini,openai,anthropic,openrouter", value: "failover" }
        ]
    },
    {
        id: "tpl-design",
        name: "zippymesh/design",
        description: "Design critique, UI/UX feedback, visual analysis, design system questions.",
        trigger: { type: "intent", value: "design" },
        rules: [
            { type: "require-capability", target: "vision", value: true },
            { type: "boost", target: "claude-sonnet", value: 85000 },
            { type: "boost", target: "gemini-2.5-pro", value: 80000 },
            { type: "boost", target: "gpt-4o", value: 75000 },
            { type: "boost", target: "claude-opus", value: 72000 },
            { type: "stack", target: "anthropic,gemini,openai,openrouter", value: "failover" }
        ]
    }
];
...
export const INITIAL_SETTINGS = {
    ...
    // Mesh discovery mode — controls which peers this node discovers and serves
    // private  : LAN mDNS + explicit allowlist only (default, safest)
    // cluster  : signed peer manifest — known nodes in a trusted cluster
    // public   : ZippyCoin getProviders + full open mesh (future)
    meshMode: "private",
    meshAllowlist: [],  // array of { nodeId, endpoint } for private/cluster modes
