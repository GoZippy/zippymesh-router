...
echo ""
echo -e "${YELLOW}⚠  Browser cache note:${NC}"
echo -e "  Your browser may still have the old UI cached."
echo -e "  After opening http://localhost:$PORT, if the dashboard looks wrong:"
echo -e ""
echo -e "    Chrome/Edge : Ctrl+Shift+Del → 'Cached images and files' → Clear"
echo -e "    Firefox     : Ctrl+Shift+Del → 'Cache' → Clear"
echo -e "    macOS       : Cmd+Shift+Del"
echo -e ""
echo -e "  Or use a hard reload: ${CYAN}Ctrl+Shift+R${NC} (Windows/Linux) / ${CYAN}Cmd+Shift+R${NC} (macOS)"
echo -e "  The dashboard will show an upgrade banner automatically if cache is stale."
