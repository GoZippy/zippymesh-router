<<<<<<< HEAD
# Contributing to ZippyMesh LLM Router (Community Edition)

Thank you for your interest in contributing. This document covers how to get the project running locally, the distinction between the private and community editions, how to submit pull requests, code style expectations, and where to start with plugin development.
=======
...
<<<<<<< HEAD
**Security vulnerabilities:** Do not open a public issue. Email security@zippymesh.io with details. See `SECURITY.md` for the full responsible disclosure policy.
=======
